...
insert into usuario values ('Admin', 'carsena', 'Serrano', 'Navia', 'Carlos', '1234', null);
insert into usuario values ('Admin', 'fersena', 'Serrano', 'Navia', 'Fernando', '1234', null);

insert into usuario values ('Profesor', 'jureher', 'Reyes', 'Hernandez', 'Julia', '1234', null);
insert into usuario values ('Profesor', 'clausepas', 'Serrano', 'Pastor', 'Claudia', '1234', null);

insert into usuario values ('Monitor', 'frandiazvi', 'Diaz', 'de Vivar', 'Francisco', '1234', '12134425');
insert into usuario values ('Monitor', 'fegarruiz', 'Garcia', 'Ruiz', 'Federico', '1234', null);
...
insert into usuario values ('Padre', 'silzavi', 'Zamora', 'de Vivar', 'Silvia', '1234', null);
insert into usuario values ('Padre', 'rismecal', 'Mejilla', 'Calvo', 'Risto', '1234', null);
insert into usuario values ('Padre', 'sercopal', 'Corazon', 'Palpito', 'Sergio', '1234', null);
insert into usuario values ('Padre', 'caacruz', 'Cruz', 'Amaya', 'Carolina', '1234', null);
